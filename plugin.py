...
class BasePlugin:
    ...
    def onStart(self):
        ...
        if len(Devices) == 0:
            Domoticz.Device(Name="External PM 2.5", TypeName="General", SubType="Custom Sensor", Unit=self.PM25, TypeName="PM 2.5", Used=1).Create()
            Domoticz.Device(Name="External PM 10", TypeName="General", SubType="Custom Sensor", Unit=self.PM10, TypeName="PM 10", Used=1).Create()
